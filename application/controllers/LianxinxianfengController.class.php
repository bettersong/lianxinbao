...
class LianxinxianfengController extends Controller
{
	...
	public function catloglistVideo()
    {
		...
		//***请设置：id和内容的字段名称
		$fieldName_id = "xianfengPushId";
		$fieldName_type = "xianfengPushType";
		$fieldName_title = "xianfengPushTitle";
		$fieldName_content = "xianfengPushContent";
		$fieldName_pushTime = "xianfengPushTime";
		$maxLen = 60;//截取的内容长度
		//end 设置
		
		$mysqlModel = new Model("xianfengpush");
		...
		foreach($catlogListArr as $index => $value){
			...
			$videobg = 'video (5).jpg';
			$catlogListArr[$index]['thumbnail'] = $videobg.'.jpg';
