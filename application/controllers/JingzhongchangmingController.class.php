...
class JingzhongchangmingController extends Controller
{
	...
	public function catloglistImg()
    {
		...
		//***请设置：id和内容的字段名称
		$fieldName_id = "keepAlarmId";
		$fieldName_type = "keepAlarmType";
		$fieldName_title = "keepAlarmTitle";
		$fieldName_content = "keepAlarmContent";
		$fieldName_pushTime = "keepAlarmTime";
		$maxLen = 60;//截取的内容长度
		//end 设置
		...
		$mysqlModel = new JingzhongchangmingModel("keepalarm");
