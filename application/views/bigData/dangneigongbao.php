...
<div class="B_main">
    ...
    <div class="B_main_right" id="tab1_content">
      <div class="BR_head">
        ...
        <span>你当前的位置：大数据监督-实用监督功能</span> </div>
      <div class="right1_one"> <span>3D环形百分比图表（本单位）</span>
        <div class="min_box">
          <ul>
            <li>
              <div class="min_box_one"></div>
              <span>已填</span> </li>
            <li>
              <div class="min_box_two"></div>
              <span>未填</span> </li>
          </ul>
        </div>
        <div class="right1_one_canvas">
          <canvas id="pie1" width="270" height="270"></canvas>
        </div>
      </div>
    </div>
  </div>
