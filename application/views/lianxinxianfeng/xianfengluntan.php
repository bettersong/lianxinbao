...
<!--中间部分main-->
<div class="B_main">
  <?php include APP_PATH."/application/views/lianxinxianfeng/left".$_m.".php"; //本栏目的公共左侧 ?>
  <div class="B_main_right">
    <div class="BR_head">
      <div class="BR_head_left"></div>
      <span>你当前的位置：廉心先锋-先锋论坛（观点）</span> </div>
    <div class="shalong_main">
      <ul>
        <li>
          <div class="SL_main_left">
            <video id="video" src="/public/video/demo2.mp4"></video>
            <img id="player" src="/public/images/player.png" alt=""> </div>
          <div class="SL_main_right">
            <p>2017年7月30日，中共中央总书记、国家主席、中央军委主席习近平在朱日和检阅部队并发表重要讲话。</p>
            <span>2017-7-30</span> </div>
        </li>
        <li>
          <div class="SL_main_left"> <img src="/public/images/player.png" alt=""> </div>
          <div class="SL_main_right">
            <p>2017年7月30日，中共中央总书记、国家主席、中央军委主席习近平在朱日和检阅部队并发表重要讲话。</p>
            <span>2017-7-30</span> </div>
        </li>
